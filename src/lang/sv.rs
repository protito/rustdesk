...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till HorusDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte HorusDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera HorusDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge HorusDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge HorusDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [HorusDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep HorusDesk background service", "Behåll HorusDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa HorusDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
