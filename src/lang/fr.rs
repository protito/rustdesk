...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau HorusDesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à HorusDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à HorusDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser HorusDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [HorusDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep HorusDesk background service", "Gardez le service HorusDesk en arrière plan"),
        ...
        ("Show HorusDesk", "Afficher HorusDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à HorusDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à HorusDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de HorusDesk en cours d'éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe HorusDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser HorusDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour HorusDesk Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher HorusDesk de fonctionner correctement en tant que machine contrôlé."),
